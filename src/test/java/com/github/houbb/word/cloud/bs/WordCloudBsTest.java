...
public class WordCloudBsTest {
    ...
    @Test
    public void zhTest() throws IOException {
        String path = "backgrounds/whale_small.png";

        final String text  = "该作讲述的是一个名为德特茅斯的衰落小镇下掩埋着一个古老的废弃王国，名叫圣巢。这个王国被瘟疫所侵蚀而废弃，废弃的原因则是因为名为辐光的光之古神，她可以通过思想来传播瘟疫，被瘟疫侵蚀的虫子都会被本能所支配，失去心智+"+
        ...
        WordCloudBs.newInstance()
                .text(text)
                .background(new PixelBoundryBackground(getInputStream(path)))
                .wordCloud();
    }
